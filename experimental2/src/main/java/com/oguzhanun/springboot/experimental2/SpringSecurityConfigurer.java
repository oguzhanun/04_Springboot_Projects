package com.oguzhanun.springboot.experimental2;
	...
	protected void configure(HttpSecurity http) throws Exception 
	{
        ...
        */
		http.authorizeRequests()
					...
					.antMatchers("/").permitAll()//hasRole("USER")//anonymous()//permitAll()//.hasRole("EMPLOYEE")
					...
					.successForwardUrl("/secured/uyeGirisi")
					.permitAll()
					.and().logout()
